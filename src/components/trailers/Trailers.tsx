            ...
            <div className="videos">
              ...
              <div className="slider-nav-2 thumb-ft">
                ...
                <div className="item">
                  <div className="trailer-img">
                    <img
                      src="/assets/images/uploads/trailer2.jpg"
                      alt="photo by Barn Images"
                      width="350"
                      height="200"
                    />
                ...
                <div className="item">
                  <div className="trailer-img">
                    <img
                      src="/assets/images/uploads/trailer6.jpg"
                ...
                <div className="item">
                  <div className="trailer-img">
                    <img
                      src="/assets/images/uploads/trailer3.png"
                ...
                <div className="item">
                  <div className="trailer-img">
                    <img
                      src="/assets/images/uploads/trailer4.png"
                ...
                <div className="item">
                  <div className="trailer-img">
                    <img
                      src="/assets/images/uploads/trailer5.jpg"
                      alt="photo by Wojciech Szaturski"
                      width="360"
                      height="189"
                    />
