                    ...
                    <div className="slick-multiItem">
                      <div className="slide-it">
                        <div className="movie-item">
                          <div className="mv-img">
                            <img
                              src="/assets/images/uploads/mv-item1.jpg"
                              alt=""
                              width="185"
                              height="284"
                            />
                      ...
                      <div className="slide-it">
                        <div className="movie-item">
                          <div className="mv-img">
                            <img
                              src="/assets/images/uploads/mv-item2.jpg"
                              alt=""
                              width="185"
                              height="284"
                            />
                      ...
                      <div className="slide-it">
                        <div className="movie-item">
                          <div className="mv-img">
                            <img
                              src="/assets/images/uploads/mv-item3.jpg"
                              alt=""
                              width="185"
                              height="284"
                            />
                      ...
                      <div className="slide-it">
                        <div className="movie-item">
                          <div className="mv-img">
                            <img
                              src="/assets/images/uploads/mv-item4.jpg"
                              alt=""
                              width="185"
                              height="284"
                            />
                      ...
                      <div className="slide-it">
                        <div className="movie-item">
                          <div className="mv-img">
                            <img
                              src="/assets/images/uploads/mv-item5.jpg"
                              alt=""
                              width="185"
                              height="284"
                            />
                      ...
                      <div className="slide-it">
                        <div className="movie-item">
                          <div className="mv-img">
                            <img
                              src="/assets/images/uploads/mv-item6.jpg"
                              alt=""
                              width="185"
                              height="284"
                            />
                      ...
                      <div className="slide-it">
                        <div className="movie-item">
                          <div className="mv-img">
                            <img
                              src="/assets/images/uploads/mv-item7.jpg"
                              alt=""
                              width="185"
                              height="284"
                            />
                      ...
                      <div className="slide-it">
                        <div className="movie-item">
                          <div className="mv-img">
                            <img
                              src="/assets/images/uploads/mv-item8.jpg"
                              alt=""
                              width="185"
                              height="284"
                            />
            ...
            <div className="sidebar">
              ...
              <div className="celebrities">
                ...
                <div className="celeb-item">
                  <a href="#">
                    <img
                      src="/assets/images/uploads/ava2.jpg"
                      alt=""
                      width="70"
                      height="70"
                    />
                ...
                <div className="celeb-item">
                  <a href="#">
                    <img
                      src="/assets/images/uploads/ava3.jpg"
                      alt=""
                      width="70"
                      height="70"
                    />
                ...
                <div className="celeb-item">
                  <a href="#">
                    <img
                      src="/assets/images/uploads/ava4.jpg"
                      alt=""
                      width="70"
                      height="70"
                    />
